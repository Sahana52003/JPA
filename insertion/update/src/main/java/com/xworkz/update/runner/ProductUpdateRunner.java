...
public class ProductUpdateRunner {
    public static void main(String[] args) {
        ...
        try{
            ...
            transaction.begin();
            UpdateEntity updateEntity=entityManager.merge(new UpdateEntity(10,"Fruity",20D,"Mango"));
            updateEntity.setCost(50D);
            updateEntity.setFlavor("Cherry");
            updateEntity.setItemName("Coco cola");

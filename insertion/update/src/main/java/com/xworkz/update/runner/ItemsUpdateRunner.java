...
public class ItemsUpdateRunner {
    public static void main(String[] args) {
        ...
        try{
            ...
            transaction.begin();
            UpdateEntity updateEntity=entityManager.merge(new UpdateEntity(8,"chips",30D,"Potato"));
            updateEntity.setCost(20D);
            updateEntity.setFlavor("Salt&Spicy");
            updateEntity.setItemName("AloPotato");

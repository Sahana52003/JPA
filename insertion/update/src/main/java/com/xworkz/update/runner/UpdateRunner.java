    ...
    public static void main(String[] args) {
        ...
        EntityManager entityManager = entityManagerFactory.createEntityManager();
           try{
            ...
            transaction.begin();
            UpdateEntity updateEntity=entityManager.merge(new UpdateEntity(6,"cake",150D,"Red Velvet"));
            updateEntity.setCost(300D);
               updateEntity.setFlavor("blue");
               updateEntity.setItemName("CAKE");
